...
fun generateFiles() {
    ...
    OVERORDNET_ENHETER.keys.forEach {
        generateJsonForOverordnetEnhet(it, OVERORDNET_ENHETER).let { jsonContent ->
            write("overordnet_enhet-$it", jsonContent)
        }
    }
