...
class EnhetsregisteretService(
    ...
    fun hentForUnderenhet(orgnr: String) = underenhetRepository.hentForUnderenhet(orgnr = orgnr)

    fun hentForOverordnetEnhet(orgnr: String) = overordnetEnhetRepository.hentForOverordnetEnhet(orgnr = orgnr)
}
